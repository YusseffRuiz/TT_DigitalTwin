...
osl_model='/../../../simhive/myo_sim/TP_model/MyoLeg_TF.xml'
myoamp_model='/../../../simhive/myo_sim/TP_model/MyoLeg71_TP_1Motor.xml'
amputationModel_OSLv2 = '/../../../simhive/myo_sim/TP_Model/myolegs_osl.xml'
...
register_env_with_variants(id='myoLegWalk_OSL-v2',
        entry_point='myosuite.envs.myo.myobase.oslwalk_v2:WalkEnvV0',
        max_episode_steps=150,
        kwargs={
            'model_path' : curr_dir + amputationModel_OSLv2,
            'normalize_act': True,
...
# Gait Torso OSL Walking ==============================
register_env_with_variants(id='myoOSLWalk-v0',
        entry_point='myosuite.envs.myo.myobase.walkOSL_v0:WalkEnvV0',
        max_episode_steps=1000,
        kwargs={
            'model_path': curr_dir + osl_model,
            'normalize_act': True,
            'min_height':0.8,    # minimum center of mass height before reset
            'max_rot':0.8,       # maximum rotation before reset
