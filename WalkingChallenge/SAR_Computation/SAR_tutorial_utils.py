...
def load_locomotion_SAR():
    ...
    """
    #root_dir = 'C:/Users/zeive/anaconda3/envs/myoSuite_ev/Lib/site-packages/myosuite/agents/SAR_pretrained/locomotion'
...
def get_animation(name, env_name, seed, episodes, determ=False,
...
def get_vid(name, env_name, seed, episodes, video_name, determ=False,
    ...
    for i,__ in tqdm(enumerate(range(episodes))):
        ...
        print("reward: ", rs)
    env.close()
    video = cv2.VideoWriter(f'Assets/{video_name}.avi',0,30.0, (640,480))
    for image in frames:
        video.write(image)
